 ...
 * PLACE ANY CUSTOMIZATIONS IN Agenc_Agencies
 */

require_once('include/SugarObjects/templates/company/Company.php');

class Agenc_Agencies_sugar extends Company {
	var $new_schema = true;
	var $module_dir = 'Agenc_Agencies';
	var $object_name = 'Agenc_Agencies';
	var $table_name = 'agenc_agencies';
	var $importable = true;
		var $id;
		var $name;
		var $date_entered;
