<?php
// $advertiserId = mysql_real_escape_string($_GET['advertiserId']);
// $advertiserId = 'eaea0d5a-7027-851d-78c4-5214f62a7773';
$popupMeta = array (
    ...
    'whereClauses' => array (
		...
		'agenc_agenc89eccounts_idb' => 'agenc_agencies_accounts_c.agenc_agenc89eccounts_idb',
	),
	// how cow this worked!
	// 'whereStatement'=> " agenc_agencies_accounts_c.agenc_agenc89eccounts_idb = '$advertiserId' ", 
	// 'fromStatement' => " INNER JOIN agenc_agencies_accounts_c ON  agenc_agencies_accounts_c.agenc_agena415gencies_ida = agenc_agencies.id ",
    'searchInputs' => array (
  0 => 'name',
  3 => 'industry',
  4 => 'address_street',
